...
namespace Corecalc {
	...
	public class TextValue : Value {
		...
		private TextValue(String value) { this.value = value; }

		public static int GetIndex(String s) { return textValueCache.GetIndex(s); }

		public static TextValue MakeInterned(String s) { return textValueCache[textValueCache.GetIndex(s)]; }
		...
		public static TextValue FromIndex(int index) { return textValueCache[index]; }
		...
		public static Value FromNakedChar(char c) { return Make(c.ToString()); }
		...
		public override bool Equals(Value v) { return v is TextValue && (v as TextValue).value.Equals(value); }
