...
namespace CoreCalc.Expressions {
	...
	/// </summary>
	internal abstract class Const : Expr {
		...
		public override Expr Move(int deltaCol, int deltaRow) { return this; }

		// Any expression can be copied with sharing
		public override Expr CopyTo(int col, int row) { return this; }
